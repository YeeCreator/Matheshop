import { parseArithExpr } from './arithParser'
import type { ArithExpr } from './arithAst'
import type { EngineEvalResponse } from './engineClient'
...
export function evalWithNativeEngine(args: NativeEngineEvalArgs): EngineEvalResponse {
